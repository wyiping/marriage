		...
		<div class="container">
			...
			<div class="services">
				<div class="col-sm-6 col-sm-push-3 login_left">
					<form action="<%=basePath%>user?cmd=edit&id=${user.userid}" method="post">
						<c:if test="${msg!=null}">
							<center style="color:red;">${msg}</center>
						</c:if>
						<div class="form-group">
							<label for="edit-username">用户名 <span class="form-required">*</span></label>
							<input type="text" id="edit-username" name="username" value="${user.username}" size="60" maxlength="60" class="form-text required">
						</div>
						<div class="form-group">
							<label for="edit-name">昵称 <span class="form-required">*</span></label>
							<input type="text" id="edit-name" name="name" value="${user.name}" size="60" maxlength="60" class="form-text required">
						</div>
						<div class="form-group">
