		...
		<div class="container">
			<div class="breadcrumb1">
				<ul>
					...
					<li class="current-page">发送的消息</li>
				</ul>
			</div>
				...
				<div class="col_4">
					<div class="bs-example bs-example-tabs" role="tabpanel" data-example-id="togglable-tabs">
						<ul id="myTab" class="nav nav-tabs nav-tabs1" role="tablist">
							<li role="presentation" class="active"><a href="#send" id="home-tab" role="tab" data-toggle="tab" aria-controls="home" aria-expanded="true">全部</a></li>
						</ul>
						<div id="myTabContent" class="tab-content">
							<div role="tabpanel" class="tab-pane fade in active" id="send" aria-labelledby="home-tab">
								<ul class="pagination pagination_1">
									<c:forEach begin="${pager.pagectrl.minpage}" step="1" end="${pager.pagectrl.maxpage}" var="index">
										...
										<c:if test="${!t}">
											<li><a href="<%=basePath%>message?cmd=sender&index=${index}">${index}</a></li>
										</c:if>
									</c:forEach>
								</ul>
								<div class="clearfix"> </div>
								...
								<div class="jobs-item with-thumb">
									<div class="thumb_top">
										...
										<div class="jobs_right">
											...
											<p class="description">${sender.message}</p>
										</div>
										<div class="clearfix"> </div>
									</div>
								</div>
